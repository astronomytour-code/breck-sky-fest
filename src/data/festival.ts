...
export const experiences: Experience[] = [
  ...
  {
    slug: 'artist-workshop', title: 'Artist workshops', subtitle: 'Make something inspired by the sky', category: 'Arts & making', filters: ['arts', 'day', 'family'], accent: 'pink', icon: 'spark', status: 'Artist & workshop TBA',
